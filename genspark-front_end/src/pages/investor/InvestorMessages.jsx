  ...
  const conversations = [
    {
      ...
      type: 'Entrepreneur',
      company: 'EcoCharge',
      lastMessage: 'Thank you for your interest! I have sent the pitch deck.',
      time: '1 hour ago',
      unread: 1,
      avatar: 'PS',
      status: 'online'
    },
    {
      ...
      type: 'Entrepreneur',
      company: 'Farm2Table',
      lastMessage: 'Looking forward to your feedback on our business model.',
      time: '3 hours ago',
      unread: 0,
      avatar: 'RP',
      status: 'offline'
    },
    {
      ...
      type: 'Entrepreneur',
      company: 'SkillUp',
      lastMessage: 'Let me know if you have any questions about the app.',
      time: '2 days ago',
      unread: 2,
      avatar: 'AK',
      status: 'online'
  ...
  const messages = [
    {
      id: 1,
      sender: 'Priya Sharma',
      message: 'Hello! Thank you for reaching out regarding EcoCharge.',
      time: '09:00 AM',
      isOwn: false
    },
    {
      id: 2,
      sender: 'You',
      message: 'Hi Priya, I am interested in learning more about your product.',
      time: '09:05 AM',
      isOwn: true
    },
    {
      id: 3,
      sender: 'Priya Sharma',
      message: 'I have sent the pitch deck to your email.',
      time: '09:10 AM',
      isOwn: false
    }
  ];
      ...
      <Container maxWidth="xl">
        <Box ref={containerRef} sx={{ display: 'flex', height: '70vh', gap: 2 }}>
          ...
          <Card sx={{ 
            flex: 1, 
            borderRadius: 3,
            background: 'rgba(120,0,255,0.13)',
            backdropFilter: 'blur(24px) saturate(180%)',
            WebkitBackdropFilter: 'blur(24px) saturate(180%)',
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent sx={{ mt: 2 }}>
          <Typography variant="body1" sx={{ mb: 3 }}>
            Schedule a video call with {conversations[selectedConversation].name} to discuss the opportunity in detail.
          </Typography>
          <TextField
            fullWidth
          ...
          <TextField
            fullWidth
            label="Meeting Topic"
            placeholder="e.g., Product Demo, Investment Discussion"
            sx={{ mb: 2 }}
          />
          <TextField
            fullWidth
